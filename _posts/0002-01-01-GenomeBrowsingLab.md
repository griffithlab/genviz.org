...
{% include figure.html image="/assets/IGV/load.data.tracks.png" width="750" %}
...
**Gene model**<br>
{% include figure.html image="/assets/IGV/gene_model.png" width="750" %}
...
**Bookmarks in IGV**<br>
{% include figure.html image="/assets/IGV/bookmarks.png" width="750" %}
...
{% include figure.html image="/assets/IGV/sort_and_group.png" width="750" %}
...
**Load repeats**<br>
{% include figure.html image="/assets/IGV/load_repeats.png" width="750" %}
...
**Automation**
{% include figure.html image="/assets/IGV/run_batch_script.png" width="750" %}
