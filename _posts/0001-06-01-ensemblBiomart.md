...
{% include question.html question="Get a hint!" answer='To learn more about Ensembl Transcript Support Levels you can read [their definitions in the Ensembl Glossary](https://www.ensembl.org/Help/Glossary?id=492) or review the [transcript table for TP53](http://www.ensembl.org/Homo_sapiens/Gene/Summary?g=ENSG00000141510)'%}
